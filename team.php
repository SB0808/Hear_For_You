...
<link rel="shortcut icon" href="images\logo_2.png">
  ...
  <body>
	  ...
	  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href="index.php"> <img src="images\logo-2.png" width="200" height="50" alt="Hear For You Logo">
    </a>
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item active"><a href="team.php" class="nav-link">Our Team</a></li>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-center">
          <div class="col-md-9 ftco-animate mb-5 text-center">
          	<p class="breadcrumbs mb-0"><span class="mr-2"><a href="index.php">Home <i class="fa fa-chevron-right"></i></a></span> <span>Our Team <i class="fa fa-chevron-right"></i></span></p>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-6 col-lg-3 ftco-animate">
						<div class="staff">
							<div class="img-wrap d-flex align-items-stretch">
								<div class="img align-self-stretch" style="background-image: url(images/dabi.png);"></div>
							</div>
							<div class="text pt-3 px-3 pb-4 text-center">
								<h3>Priyanshi Dabi</h3>
								<span class="position mb-2">HFY</span>
								<div class="faded">
					...
					<div class="col-md-6 col-lg-3 ftco-animate">
						<div class="staff">
							<div class="img-wrap d-flex align-items-stretch">
								<div class="img align-self-stretch" style="background-image: url(images/sb.enc);"></div>
							</div>
							<div class="text pt-3 px-3 pb-4 text-center">
								<h3>Shreyas Badodkar</h3>
								<span class="position mb-2">HFY</span>
								<div class="faded">
									<p>Lorem Ipsum, sometimes referred to as 'lipsum', is the placeholder text used in design when creating content.</p>
									<ul class="ftco-social text-center">
    ...
    <footer class="ftco-footer">
	  ...
	  </script> All rights not reserved | This website is made with <i class="fa fa-heart color-danger" aria-hidden="true"></i> by <a href="index.php" target="_blank">HFY Team</a>
	  </p>
	          </div>
	        </div>
      	</div>
