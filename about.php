    ...
    <section class="ftco-section ftco-no-pb ftco-no-pt">
			<div class="container">
	          ...
	          <div class="heading-section py-md-5">
	            ...
	            <h3 class="mb-4">A Safe and Comfortable Space where Listening goes beyond Words.</h3>
...
<br>
    ...
    <section class="ftco-section testimony-section">
    	<div class="img img-bg border" style="background-image: url(https://img.freepik.com/premium-vector/beautiful-lake-surrounded-by-mountains-autumn-trees-during-sunrise-sunset-scenery-detailed-hand-drawn-painting-illustration_128685-1158.jpg?size=626&ext=jpg&ga=GA1.1.1546980028.1702598400&semt=ais);"></div>
    	<div class="overlay"></div>
      <div class="container">
        <div class="row justify-content-center mb-5">
          <div class="col-md-7 text-center heading-section heading-section-white ftco-animate">
          	<span class="subheading">Introduction</span>
            <h2 class="mb-3">HFY</h2>
          </div>
        </div>
            ...
            <div class="carousel-testimony owl-carousel ftco-owl">
              <div class="item">
                <div class="testimony-wrap py-4">
                  ...
                  <div class="text">
                    <p class="mb-4">At Hear for You, we are a dedicated team of listeners, companions on your journey through life's challenges.</p>
                    <div class="d-flex align-items-center">
                    	<div class="user-img" style="background-image:  url(images/logo_2.png)"></div>
                    	<div class="pl-3">
		                    <p class="name">Who We Are</p>
		                    <span class="position">HFY</span>
		                  </div>
	                  </div>
                  </div>
                </div>
              ...
              <div class="item">
                <div class="testimony-wrap py-4">
                	<div class="icon d-flex align-items-center justify-content-center"><span class="fa fa-quote-left"></div>
                  <div class="text">
                    <p class="mb-4">Our purpose is to create a haven where open hearts replace judgment, and empathy knows no bounds.</p>
                    <div class="d-flex align-items-center">
                    	<div class="user-img" style="background-image: url(images/logo_2.png)"></div>
                    	<div class="pl-3">
		                    <p class="name">Our Purpose</p>
		                    <span class="position">HFY</span>
		                  </div>
	                  </div>
                  </div>
              ...
              <div class="item">
                <div class="testimony-wrap py-4">
                	<div class="icon d-flex align-items-center justify-content-center"><span class="fa fa-quote-left"></div>
                  <div class="text">
                    <p class="mb-4">We offer listening sessions and connections that go beyond mere conversations.</p>
                    <div class="d-flex align-items-center">
                    	<div class="user-img" style="background-image: url(images/logo_2.png)"></div>
                    	<div class="pl-3">
		                    <p class="name">What We Offer</p>
		                    <span class="position">HFY</span>
		                  </div>
	                  </div>
                  </div>
              ...
              <div class="item">
                <div class="testimony-wrap py-4">
                	<div class="icon d-flex align-items-center justify-content-center"><span class="fa fa-quote-left"></div>
                  <div class="text">
                    <p class="mb-4">Our trained listeners are here to provide a supportive and understanding ear. No matter what you're going through.</p>
                    <div class="d-flex align-items-center">
                    	<div class="user-img" style="background-image: url(images/logo_2.png)"></div>
                    	<div class="pl-3">
		                    <p class="name">Listening Sessions</p>
		                    <span class="position">HFY</span>
		                  </div>
	                  </div>
                  </div>
              ...
              <div class="item">
                <div class="testimony-wrap py-4">
                	<div class="icon d-flex align-items-center justify-content-center"><span class="fa fa-quote-left"></div>
                  <div class="text">
                    <p class="mb-4">Fostering healing through shared experiences and emotions, we build connections and community.</p>
                    <div class="d-flex align-items-center">
                    	<div class="user-img" style="background-image: url(images/logo_2.png)"></div>
                    	<div class="pl-3">
		                    <p class="name">Connection</p>
		                    <span class="position">HFY</span>
		                  </div>
	                  </div>
                  </div>
...
<div class="col-md-6">
    ...
    <footer class="ftco-footer">
	  ...
	  </script> All rights not reserved | This website is made with <i class="fa fa-heart color-danger" aria-hidden="true"></i> by <a href="index.php" target="_blank">HFY</a>
	  </p>
	          </div>
	        </div>
      	</div>
